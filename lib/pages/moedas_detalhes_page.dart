  ...
  callDataCharts(int numberSpots, int posicao) {
    setState(() {
      ...
      if(numberSpots == 5) {
        ...
        data.clear();
        for(int i = 0; i < 5 ; i++){
          data2  = ChartData(tabela[posicao].dia_5[i], tabela[posicao].valor_5[i]);
          data.add(data2);
        ...
        data.clear();
        for(int i = 0; i < 10 ; i++ ) {
          data2  = ChartData(tabela[posicao].dia_10[i], tabela[posicao].valor_10[i]);
          data.add(data2);
        }
        ...
        data.clear();
        for(int i = 0; i < 15 ; i++ ) {
          data2  = ChartData(tabela[posicao].dia_15[i], tabela[posicao].valor_15[i]);
          data.add(data2);
        }
        ...
        data.clear();
        for(int i = 0; i < 30 ; i++ ) {
          data2  = ChartData(tabela[posicao].dia_30[i], tabela[posicao].valor_30[i]);
          data.add(data2);
        }
      }else {
        ...
        data.clear();
        for(int i = 0; i < 50 ; i++ ) {
          data2  = ChartData(tabela[posicao].dia_50[i], tabela[posicao].valor_50[i]);
          data.add(data2);
        }
      }
                        ...
                        ListTile(
                          ...
                          trailing:
                             Text(
                              ...
                              style: TextStyle( color: (widget.moeda.variacao > 0) ? Colors.green : Colors.red,
                                  backgroundColor: (widget.moeda.variacao > 0) ?  Colors.green[50] : Colors.red[50]),
